  ...
  return (
    <div className="relative bg-navy/70 border border-teal/20 rounded-lg p-4 md:p-6">
      <div className="flex justify-between items-center mb-4 md:mb-6 flex-wrap">
        <h3 className="text-base md:text-lg font-medium">Enterprise-Grade Security</h3>
      ...
      <div className="md:hidden space-y-3">
        <div className="bg-navy/50 border border-teal/20 rounded-lg p-3">
          <div className="flex justify-between items-center mb-2">
            <span className="text-sm font-medium">API Security Layer</span>
            <span className="text-xs bg-teal/10 text-teal px-2 py-0.5 rounded-full">In Dev</span>
          </div>
          <div className="text-xs text-gray-400">Authentication, Rate Limiting, Request Validation</div>
        </div>
        
        <div className="flex justify-center my-1">
          <div className="h-5 w-0.5 bg-teal/30"></div>
        </div>
        
        <div className="bg-navy/50 border border-teal/20 rounded-lg p-3">
          <div className="flex justify-between items-center mb-2">
            <span className="text-sm font-medium">Core Orchestration</span>
            <span className="text-xs bg-teal/10 text-teal px-2 py-0.5 rounded-full">In Dev</span>
          </div>
          <div className="text-xs text-gray-400">Compliance Engine, Model Orchestration</div>
        </div>
        ...
        <div className="bg-navy/50 border border-teal/20 rounded-lg p-3">
          ...
          <div className="text-xs text-gray-400">End-to-End Encryption, Access Controls</div>
        </div>
        
        <div className="flex flex-wrap justify-center gap-2 mt-4">
          <div className="bg-navy/50 border border-teal/20 px-2 py-1 rounded-full text-xs">
            SOC 2
          </div>
          <div className="bg-navy/50 border border-teal/20 px-2 py-1 rounded-full text-xs">
            GDPR
